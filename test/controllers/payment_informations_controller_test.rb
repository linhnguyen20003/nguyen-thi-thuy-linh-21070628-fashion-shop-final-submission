...
class PaymentInformationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payment_information" do
    assert_difference("PaymentInformation.count") do
      post payment_informations_url, params: { payment_information: { infomation_id: @payment_information.infomation_id, invoice_number: @payment_information.invoice_number, payment_date: @payment_information.payment_date, type: @payment_information.type } }
    end
  ...
  test "should update payment_information" do
    patch payment_information_url(@payment_information), params: { payment_information: { infomation_id: @payment_information.infomation_id, invoice_number: @payment_information.invoice_number, payment_date: @payment_information.payment_date, type: @payment_information.type } }
